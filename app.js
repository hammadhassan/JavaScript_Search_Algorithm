...
var h;
    ...
    return h;
    h.push = document.getElementById("result").innerHTML = array;
  }  
...
function search() {
    var rows = "";
    array.sort();
    var result = document.getElementById("class").value ;
    rows += "<tr><td>" + classes + "</td><td>" + name + "</td><td>" + id ;
}
//
function AddData(){
        ...
        if((parseInt(x)!=(x))&&(y==parseInt(y))){
            ...
            //var ids = document.hasAttribute("id", "id.value");
            rows += "<tr><td>" + classes + "</td><td>" + name + "</td><td>" + id ;
